...
public class Accelerators extends HttpServlet {
    ...
    public static void jsonResponse(HttpServletResponse response, String ContentType, String message) throws IOException {
    ...
    public void sender(HttpServletResponse response, String ContentType, String message) throws IOException {
        //default to json
        jsonResponse(response, ContentType, message);
